...
public class FilterDemo {
    ...
    public static int getNumFilteredRows(JTable table) {
        return table.getRowCount();
    }

    public static JTextField createRowFilter(final JTable table) {
        ...
        final TableRowSorter<? extends TableModel> rowSorter =
